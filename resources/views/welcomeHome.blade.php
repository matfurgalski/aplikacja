  ...
  <div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      ...
      <div class="col-md-3 text-end">
        <a href="{{ route('login') }}" type="button" class="btn btn-outline-primary me-2">Zaloguj</a>
        <a href="{{ route('register') }}" type="button" class="btn btn-primary">Zarejestruj się</a>
      </div>
    </header>
  </div>

  <div class="px-4 pt-5 my-5 text-center border-bottom">
    <h1 class="display-4 fw-bold">Aplikacja wspomagająca wynajem mieszkań</h1>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">Aplikacja przeznaczona dla osób chcących posiadać w jednym miejscu kluczowe informacje na temat wynajmowanego mieszkania, jak również chcących wystawić na tablicy ogłoszeń swoją nieruchomość dla potencjalnych najemców.</p>
      <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
        <a href="{{ route('register') }}" type="button" class="btn btn-primary btn-lg px-4 me-sm-3">Zacznij korzystać!</a>
       
      </div>
    </div>
    <div class="overflow-hidden" style="max-height: 30vh;">
      <div class="container px-5">
        <img src="../img/wynajem-app_dashboard.png" class="img-fluid border rounded-3 shadow-lg mb-4" alt="Example image" width="700" height="500" loading="lazy">
      </div>
    </div>
  </div>
