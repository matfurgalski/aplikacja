...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Dodaj Ogłoszenie</h1>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('ogloszenia.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="tytul" type="text" class="form-control @error('nazwa') is-invalid @enderror" name="tytul" value="{{ old('tytul') }}" required autocomplete="nazwa" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="opis" class="form-control @error('opis') is-invalid @enderror" name="opis"  autofocus>{{ old('surname') }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="cena" type="number" class="form-control @error('cena') is-invalid @enderror" name="cena" required autocomplete="cena">
